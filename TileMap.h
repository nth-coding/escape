...
public:
	...
	void render(sf::RenderTarget& target, const sf::Vector2i& gridPosition, const sf::Vector2f playerPosition = sf::Vector2f(), const bool show_collision = false);
	void renderDeferred(sf::RenderTarget& target, const sf::Vector2f playerPosition = sf::Vector2f());
};
