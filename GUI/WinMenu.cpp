...
WinMenu::WinMenu(sf::VideoMode& vm, sf::Font& font) : font(font)
{
	...
	this->menuText.setString("You Won! Thank you so much for playing <3");
...
std::map<std::string, gui::Button*>& WinMenu::getButtons()
{
	return this->buttons;
}

//Functions
const bool WinMenu::isButtonPressed(const std::string key)
{
	return this->buttons[key]->isPressed();
}

void WinMenu::addButton(
...
void WinMenu::update(const sf::Vector2i& mousePosWindow)
{
...
void WinMenu::render(sf::RenderTarget & target)
{
